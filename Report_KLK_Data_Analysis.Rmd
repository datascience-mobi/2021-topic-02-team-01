...
```{r Broken chip - lung qc, echo=FALSE, fig.align="center", fig.cap="Example of scatter plot breast cancer GSE65216.", out.width="50%", fig.pos="H", out.extra =''}
...
```{r TRA -piechart, echo=FALSE, fig.align="center", fig.cap="Tissue specificy of KLK genes - KLK genes from six TRA datasets are combined and sorted for tissue specificity", out.width="50%", fig.pos="H", out.extra =''}
...
```{r order transcripts - breast cancer, eval=FALSE, include=FALSE}
...
```{r Histogram - breast , echo=FALSE, fig.align="center", fig.cap="Histogram of breast cancer gene expression.", out.width="50%", fig.pos="H", out.extra =''}
...
In figure X two of the six clusters are clearly separated. Cluster 1 contains KLK4.4 and KLK8.8, while cluster 4 contains KLK5, KLK5.3, KLK6 and KLK10.3. The respective KLKs out of these two clusters will be further analyzed.   
...
In conclusion, the analyzed altered expression of KLKs in different mutation and tissue type could partially confirmed by the literature. In the breast cancer dataset KLK8.8 was the only non-TRA over-expressed gene that, which could be a subject of further investigation. In the lung cancer dataset KLK12 over-expression in lung cancer was 
