...
```
The difference in expression between the mutations types, within a gene, were determined with the Wilcoxon-Mann-Whitney-Test. The significant differences are indicated in the panel plot with bars.
In a previous study (Haritos et al. 2018) KLK6 expression was found to be generally downregulated in breast cancer tissue, but in HER2 and TNBC positive tumors it is overexpressed. These results could only 


KLK8.4 was not identified as a clear indicator for Her2, in contrast to KLK6 where Her2 was significantly higher expressed then LumB. These results are coherent with Haritos et al. findings that KLK6 is generally downregulated in breast cancer tissue, but in HER2 and TNBC positive tumors it is overexpressed. For TNBC significant overexpression in comparison to the other mutation  samples in KLK6 could not be confirmed, although the boxplot indicates  
Michaelidou et al. reported a higher expression of KLK8 in TNBC and Her2 positive tumors compared to LumA and LumB positive tumors. However, this analysis could only confirm significant TNBC overexpression for the isoform KLK8.5 compared to LumA and LumB. Nevertheless, the boxplots of KLK8.4 and KLK8.5 show the trend of Her2 and TNBC overexpression. 



Although, the dataset had no normal tissue to compare the expression to, these results are cohered with the findings of Haritos et al. which confirmed Her2 and TNBC overexpression in TNBC
KLK11 and KLK11.2 orientation in the PCA loadings suggested a correlation with LumA, but this could not be confirmed by the Hypothesis testing. 


Four genes (KLK5,5.3,10,10.3) were significantly higher expressed in the TNBC samples compared to the Her2 samples. The expression values of the TNBC samples were also significantly higher than 
