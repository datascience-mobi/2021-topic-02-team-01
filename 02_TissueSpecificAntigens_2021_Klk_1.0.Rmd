...
row.ind=which(toupper(prostate.TRA1) %in% as.character(symbol))

data.breast.matrix.prostate =data.Klk.breast.matrix[row.ind,] ##Only genes in prostate! ##HERES PROBABLY A MISTAKE SINCE row.ind just counts fro m1 to 97 and so picks wrong rows
