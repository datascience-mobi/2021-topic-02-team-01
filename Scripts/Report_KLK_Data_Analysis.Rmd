...
```{r Boxplots - breast qc, echo=FALSE, fig.align="center", fig.cap="Example of scatter plot breast cancer GSE65216", out.width="50%"}
knitr::include_graphics("images/breast_scatter_example1.png")
```
...
The breast cancer microarray GSE65216 (Maire et al. 2013) consists of 20 samples. The samples are all breast cancer tissue differentiated by four types of mutations. These are Triple negative breast cancer (TNBC), Her2, Luminal A and Luminal B.  
...
```{r Heatmap - breast , echo=FALSE, fig.align="center", fig.cap="Dendrogram of KLK genes in breast cancer", out.width="50%"}
...
### Clean up identical isoforms
The clean up follows the same method shown for the breast cancer data set. This results in 73 KLK gene isoforms, 63 of which are TRAs.
### Visualization of gene expression 
