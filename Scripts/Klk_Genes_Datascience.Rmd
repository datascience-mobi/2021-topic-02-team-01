...
pdf("breast_RNAdeg_bfnorm.pdf")
plotAffyRNAdeg(rnadeg.breast, col = rainbow(150))
title(sub="GSE65216 (Maire et al. 2013) before normalization")
dev.off()

pdf("breast_RNAdeg_afnorm.pdf")
plotAffyRNAdeg(rnadeg.breast, col = rainbow(150), transform = "shift.only")
title(sub="GSE65216 (Maire et al. 2013) after normalization")
dev.off()
```
...
boxplot(lung, col=rainbow(150),cex.axis=0.5,main="GSE149507 gene expression before normalization", las = 2)
dev.off()
...
boxplot(exprs(lung.vsnrma),col=rainbow(150),cex.axis=0.5,main="GSE149507 gene expression after normalization" , las=2)
dev.off()
```
