...
par(las=2)
##Experimental
boxplot(all.KLK.rawdata,col=rainbow(length(rownames(TRA.KLK.TRA1))),main="gene expression of KLK genes in human breast cancer",cex.axis=0.8)
pheatmap(all.KLK.rawdata)

x1 = cor(TRA.all.KLK)
head(x1)
pheatmap(x1) # corr between patients
x2 = cor(t(TRA.all.KLK))
head(x2)
pheatmap(x2)
