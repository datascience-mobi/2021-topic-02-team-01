...
boxplot(all.KLK.rawdata,col=rainbow(length(rownames(data.KLK.rawdata))),main="gene expression of KLK genes in human breast cancer",cex.axis=0.8)
...
```
Test for correlation between KLKs
```{r}
...
#delete diagonal 
diag(cor.rawdata.breast)=NA
cor.rawdata.breast
which(cor.rawdata.breast == 1)
