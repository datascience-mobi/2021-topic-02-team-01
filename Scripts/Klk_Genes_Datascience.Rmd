...
pdf("Scatterplots_lungcancer_chips.pdf")
...
setwd(here("Plots/Plots_lung_qc"))
pdf("lung_cancer_broken_chip.pdf")
...
title(main=paste("Scaterplot of probe", substr(colnames(lung.vsnrma)[9],1,
