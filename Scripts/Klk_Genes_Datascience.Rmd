...
colnames(samples.annotation.lung) <- "tumor type"                                 
...
#Histograms of genes expression
#rawdataExprs is not cleaned of identical values
median(lungExprs)  #Median all genes: 
mean(lungExprs)    #Mean all genes: 

median(unlist(all.KLK.lung.clean)) #Median all KLKs: 
mean(unlist(all.KLK.lung.clean))   #Mean all KLKs: 

median(unlist(TRA.KLK.lung.clean)) #Median TRA KLKs: 
mean(unlist(TRA.KLK.lung.clean))   #Mean TRA KLKs: 
