...
## All KLK genes in the three data sets
...
#14 isoforms seem to be identical
...
TRA.KLK.rawdata.clean = t(TRA.KLK.rawdata.clean[,order.hand.TRA])
```
...
TRA.KLK.breast.clean = t(TRA.KLK.breast.clean[,order.hand.TRA])
